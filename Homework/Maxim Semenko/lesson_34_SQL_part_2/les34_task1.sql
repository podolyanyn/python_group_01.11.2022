SELECT E.first_name, E.last_name, E.department_id, D.depart_name FROM employees as E LEFT JOIN departments as D ON E.department_id = D.department_id;
SELECT E.first_name, E.last_name, D.depart_name,  L.city, L.state_province FROM employees  as E INNER JOIN departments as D ON E.department_id = D.department_id LEFT JOIN locations as L on D.location_id = L.location_id;
...
SELECT D.depart_name as  'Department Name', count(E.employee_id)  as 'No. of employees' FROM employees as E RIGHT JOIN departments as D on E.department_id =  D.department_id GROUP BY E.department_id